...
<div class="row justify-content-between">
    <div class="col like-box">
		<?= $form->field($model, 'VAT')->input('number', ['step' => 0.01]) ?>
    </div>
</div>

<div class="row justify-content-between">
    <div class="col like-box">
		<?= AdminHelper::getSelectWidget($form, $model, 'rel_deliveries', ArrayHelper::map(\common\models\Delivery::find()->all(), 'id', 'native_name'), ['multiple' => true])?>
    </div>
</div>
