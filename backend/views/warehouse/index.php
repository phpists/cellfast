...
$columns = [
	...
	[
		'attribute' => 'locationPlace.native_name',
		'label' => Yii::t('app', 'Place'),
		'format' => 'raw',
		'value' => function($model, $key, $index, $column) {
			return $model->locationPlace ? Html::a($model->locationPlace->native_name, ['update', 'id' => $model->id]) : null;
		}
	],
	[
		'attribute' => 'locationRegion.native_name',
		'label' => Yii::t('app', 'Region'),
		'format' => 'raw',
		'value' => function($model, $key, $index, $column) {
			return $model->locationRegion ? Html::a($model->locationRegion->native_name, ['update', 'id' => $model->id]) : null;
		}
	],
	[
		'attribute' => 'locationCountry.native_name',
		'label' => Yii::t('app', 'Country'),
		'format' => 'raw',
		'value' => function($model, $key, $index, $column) {
			return $model->locationCountry ? Html::a($model->locationCountry->native_name, ['update', 'id' => $model->id]) : null;
		}
	],
	[
		'format' => 'raw',
