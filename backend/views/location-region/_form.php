...
<div class="row justify-content-between">
    <div class="col like-box">
		...
		<?= AdminHelper::getSelectWidget($form, $model, 'country_id', ArrayHelper::map(\common\models\LocationCountry::find()->select(['id', 'native_name'])->asArray()->all(), 'id', 'native_name'))?>
			...
			<?php foreach (Yii::$app->languages->languages as $language) :?>
				<?= $form->field($model, "body_{$language->suffix}")->widget(Widget::className(), [
					'settings' => [
						...
						'imageUpload' => Url::to(['location-region/body-image-upload']),
						'imageManagerJson' => Url::to(['location-region/body-images-get']),
						'imageDelete' => Url::to(['location-region/body-file-delete']),
						'plugins' => [
							'fullscreen',
							'table',
							'video',
