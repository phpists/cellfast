...
$this->title = 'Где купить продукцию CELLFAST?';
$this->params['breadcrumbs'][] = Yii::t('app', 'Where can I buy');

\cellfast\assets\PartnersAsset::register($this);
...
<section class="buy">
    <div class="container">
        ...
        <div class="buy__title"><span><?= Yii::t('app', 'Where can I buy') ?></span></div>
													...
													<?php foreach($locationRegion->partner as $partner) : ?>
                                                        ...
                                                        <li class="buy-navigation-item-list__item js-buy-navigation-item-list__item">
                                                            ...
                                                            <a href="#" <?= $dataItemLocation ?>
                                                               data-item-zoom="16"
                                                               data-item-address="<?= $partner->address ?>"
