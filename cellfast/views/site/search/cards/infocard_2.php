 ...
 */
?>
<div class="product__top__right _v2">
...
<!--                <div class="product__top__right__har-title"><span>--><?//= Yii::t( 'app', 'Choice of features' ) ?><!--</span></div>-->
            ...
            <div class="product__top__right__cnt__right product-order-item-wrapper" data-id="<?= $model->item->id?>" data-params="<?= json_encode((object)[])?>">
<!--                <div class="product__top__right__har-list"><a href="javascript:;" data-toggle="modal" data-target="#select_list_items">--><?//= Yii::t( 'app', 'Selecting from the list' ) ?><!--</a></div>-->
