 ...
 * дуль задачи с app/cellfast/views/catalog/product/cards/parts/calculator.php:4
 **/
$itemParam = "[{\"count\": {$model->productItem->packages['pallet']},\"name\": \"Паллет\"},{\"count\": {$model->productItem->packages['packet']},\"name\": \"Упаковка\"}]";
?>
