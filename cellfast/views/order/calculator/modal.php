	...
	<div class="dropdown-calculator calculator__dropdown__box">
		...
		<div class="calculator__dropdown__box__body">
			<div class="calculator_row">
				<div class="calculator_cell dropdown__select_container">
					<div class="dropdown__select">
						<label data-count="20" data-target="none" class="form-control calculate_size">Паллет</label>
					</div>
			...
			<div class="calculator_row">
				...
				<div class="calculator_cell">
					<input type="text" value="20" class="form-control calculator_inpack"/>
				</div>
			</div>
			<div class="calculator_row">
				<div class="calculator_cell allwidth"><a href="javascript:;" class="btn btn_blue calculator__ok">ОК</a></div>
			</div>
		</div>
	</div>
</div>