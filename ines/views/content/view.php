...
<div class="main-content">
        ...
        <div class="container">
			...
			<?php if ( $model->images ) : ?>
                <div class="<?= $__params['id']?>-images">
					<?= \ines\widgets\ImageGallery::widget([
						'items' => $model->images,
					])?>
                </div>
			<?php endif ?>
	...
	<?= RelatedContentWidget::widget([
		'title' => 'Другие статьи',
		'items' => \ines\models\Article::find()->where(['project_id' => Yii::$app->projects->current->alias])->limit(3)->orderBy(['published_at' => SORT_DESC])->all(),
