...
class SiteController extends \common\controllers\SiteController
{
    ...
    public function actionSearch()
    {
        ...
        $products = \common\models\Product::find()
            ...
            ->where(['AND', ['OR', ['LIKE', 'product.native_name', $searchRequest], ['LIKE', 'product_item.sku', $searchRequest]], 'product.project_id="ines"'])
            ->distinct();
        ...
        $articles = Article::find()
            ->where(['AND', ['OR', ['LIKE', $name_field, $searchRequest], ['LIKE', $content_field, $searchRequest]], 'article.project_id="ines"'])
            ->offset($offset)
