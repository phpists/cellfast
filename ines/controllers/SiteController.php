...
use ines\models\LoginForm;
use ines\models\SignupForm;
use yii\base\InvalidParamException;
use ines\models\ContactForm;
use yii\web\BadRequestHttpException;
use ines\models\PasswordResetRequestForm;
use ines\models\ResetPasswordForm;
...
class SiteController extends \common\controllers\SiteController
{
    ...
    public function actionSearch()
    {
        ...
        $products = \common\models\Product::find()
            ...
            ->where(['AND', ['OR', ['LIKE', 'product.native_name', $searchRequest], ['LIKE', 'product_item.sku', $searchRequest]], 'product_item.project_id="ines"'])
            ->distinct();
        ...
        $articles = Article::find()
            ->where(['AND', ['OR', ['LIKE', $name_field, $searchRequest], ['LIKE', $content_field, $searchRequest]], 'product_item.project_id="ines"'])
            ->offset($offset)
